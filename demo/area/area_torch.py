...
plt.subplot(233)
utils.scatter_otsamples(vot.y, vot.x, color_x=ce, size_e=5, title='after', facecolor_p='none')
...
ce = np.array(plt.get_cmap('viridis')(e_idx.cpu().numpy() / (N - 1)))
plt.subplot(236)
utils.scatter_otsamples(vot2.y, vot2.x, color_x=ce, title='after', facecolor_p='none')
